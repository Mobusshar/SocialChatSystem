...
if (isset($_POST["submit"])) {
    ...
    if ($user_validity > 0) {
        ...
        if ($online_status_validity > 0) {
            ...
            header("Location:./Dashboard/Private_Message/Private_Message.php");
...
<body>
  ...
  <input class='lf--submit' type='submit' value='LOGIN' name="submit" id="btnSubmit">
	  ...
	  <p style="font-size:.7em;color:#2dc6bf;text-align:center;cursor:hand"><u><a style="color:#2dc6bf" href="Home.php">Home</a></u></p>
